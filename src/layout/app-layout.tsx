...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Follow', path: '/follows', entity: 'follow', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    { name: 'Media', path: '/media', entity: 'media', service: AccessServiceEnum.PROJECT, icon: FiImage },
    { name: 'Tweet', path: '/tweets', entity: 'tweet', service: AccessServiceEnum.PROJECT, icon: FiTwitter },
